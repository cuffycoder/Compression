...
public class HuffmanTree<SegmentType> {
    ...
    private void buildTreeFromFrequencyTable() {
        ...
        // Sort by frequency
        workingTable.sort( ( a, b ) -> a.getFrequency() - b.getFrequency() );
    ...
    class HuffNode<SegmentType> {
        ...
        public void setSegmentValue( SegmentType segval ) { segmentValue = segval; }

        public SegmentType getSegmentValue() { return segmentValue; }

        public void setFrequency( int frequency ) { this.frequency = frequency; }

        public int getFrequency() { return frequency; }

        public boolean isLeaf() { if( segmentValue != null ) return true; return false; }

        public void setLeft( HuffNode node ) { this.left = node; }

        public void setRight( HuffNode node ) { this.right = node; }
    }
